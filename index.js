...
function loadCurrentBetDetails(){
	...
	let numberOfBets=contractInstance.numberOfBets.call().toNumber();
	let lastWinner=contractInstance.lastWinner.call().toNumber();
	let totalBet=web3.fromWei(contractInstance.totalBet.call().toNumber());
	let minimumBet=web3.fromWei(contractInstance.minimumBet.call().toNumber());
	let maxAmountOfBets=contractInstance.maxAmountOfBets.call().toNumber();

	$('#numberOfBets').html(document.createTextNode(numberOfBets.toString()));
	$('#lastWinner').html(document.createTextNode(lastWinner.toString()));
	$('#totalBet').html(document.createTextNode(totalBet.toString()));
	$('#minimumBet').html(document.createTextNode(minimumBet.toString()));
	$('#maxAmountOfBets').html(document.createTextNode(maxAmountOfBets.toString()));
}
...
$('#num-1').click(function(){
	...
	let minimumBet=contractInstance.minimumBet.call().toNumber();
